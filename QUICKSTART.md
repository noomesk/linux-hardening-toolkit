# 🛡️ Linux Hardening Toolkit - Guía de Inicio Rápido
...
- **Diseño Cyberpunk Moderno**: Tema oscuro con efectos neón
...
│   │   └── FullReport.tsx
│   ├── styles/
│   │   └── globals.css      # Estilos Tailwind cyberpunk
│   └── package.json
│
├── README.md
...
2. **Entorno Sandbox**: Este está corriendo en un entorno sandbox, por lo que algunas herramientas (UFW, SELinux, etc.) pueden no estar disponibles
...
El proyecto está **100% funcional** y listo para usar. Disfruta explorando las herramientas de hardening de Linux!
